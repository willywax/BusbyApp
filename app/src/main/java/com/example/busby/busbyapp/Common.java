...
public class Common {
    ...
    static final String NOTIFICATION_PUSH_URL = "http://busby-web.gear.host/android_php/notificationPost.php";
    ...
    static final String StoreID_PULL = "http://busby-web.gear.host/android_php/StoreIDPull.php";
